...
namespace SCMM.Web.Shared
{
    public static class SteamExtensions
    {
        ...
        public static string GetItemType(this IDictionary<string, string> itemTags, string itemName)
        {
            ...
            if (itemTags.ContainsKey(SteamConstants.SteamAssetTagItemType))
            {
                itemType = Uri.EscapeDataString(
                    itemTags[SteamConstants.SteamAssetTagItemType]
                );
            }
            else if (itemTags.ContainsKey(SteamConstants.SteamAssetTagWorkshop))
            {
                itemType = Uri.EscapeDataString(
