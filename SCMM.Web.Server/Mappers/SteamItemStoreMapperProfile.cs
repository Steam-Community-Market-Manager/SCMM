    ...
    public class SteamItemStoreMapperProfile : Profile
    {
        public SteamItemStoreMapperProfile()
        {
            ...
            CreateMap<SteamStoreItemItemStore, StoreItemDetailsDTO>()
                ...
                .ForMember(x => x.IsPublisherDrop, o => o.MapFrom(p => p.Item.Description.IsPublisherDrop))
                .ForMember(x => x.IsLootCrateDrop, o => o.MapFrom(p => p.Item.Description.IsLootCrateDrop))
