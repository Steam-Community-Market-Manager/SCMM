    ...
    public class SteamItemStoreMapperProfile : Profile
    {
        public SteamItemStoreMapperProfile()
        {
            ...
            CreateMap<SteamStoreItemItemStore, StoreItemDetailsDTO>()
                ...
                .ForMember(x => x.DominantColour, o => o.MapFrom(p => p.Item.Description.DominantColour))
                ...
                .ForMember(x => x.MarketSupply, o => o.MapFrom(p => p.Item.Description.MarketItem != null ? (long?)p.Item.Description.MarketItem.Supply : null))
