        ...
        public async Task<GenerateSteamProfileInventoryThumbnailResponse> HandleAsync(GenerateSteamProfileInventoryThumbnailRequest request)
        {
            ...
            var inventoryItemIcons = await _db.SteamProfileInventoryItems
                ...
                .Select(x => new
                {
                    ...
                    ValueUp = (x.Description.MarketItem != null ? x.Description.MarketItem.Last48hrValue - x.Description.MarketItem.Open24hrValue > 0 : false),
                    ValueDown = (x.Description.MarketItem != null ? x.Description.MarketItem.Last48hrValue - x.Description.MarketItem.Open24hrValue < 0 : false),
