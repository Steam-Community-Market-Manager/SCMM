...
namespace SCMM.Steam.Data.Store.Migrations.Steam
{
    ...
    [Migration("20210128083226_CascadeDeleteEntities")]
    partial class CascadeDeleteEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.ImageData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamApp", b =>
                {
                    b.HasOne("SCMM.Steam.Data.Store.Models.Steam.ImageData", "Icon")
                        .WithMany()
                        .HasForeignKey("IconId");

                    b.HasOne("SCMM.Steam.Data.Store.Models.Steam.ImageData", "IconLarge")
                        .WithMany()
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamAssetWorkshopFile", b =>
                {
                    ...
                    b.HasOne("SCMM.Steam.Data.Store.Models.Steam.ImageData", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamProfile", b =>
                {
                    b.HasOne("SCMM.Steam.Data.Store.Models.Steam.ImageData", "Avatar")
                        .WithMany()
                        .HasForeignKey("AvatarId");

                    b.HasOne("SCMM.Steam.Data.Store.Models.Steam.ImageData", "AvatarLarge")
                        .WithMany()
