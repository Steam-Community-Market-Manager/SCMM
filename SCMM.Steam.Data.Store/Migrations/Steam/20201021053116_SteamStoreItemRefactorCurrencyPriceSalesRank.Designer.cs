...
namespace SCMM.Steam.Data.Store.Migrations.Steam
{
    ...
    [Migration("20201021053116_SteamStoreItemRefactorCurrencyPriceSalesRank")]
    partial class SteamStoreItemRefactorCurrencyPriceSalesRank
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamInventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamInventoryItem", b =>
                {
                    ...
                    b.HasOne("SCMM.Steam.Data.Store.Models.Steam.SteamMarketItem", "MarketItem")
                        .WithMany()
                        .HasForeignKey("MarketItemId");

                    b.HasOne("SCMM.Steam.Data.Store.Models.Steam.SteamProfile", "Owner")
                        .WithMany("InventoryItems")
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamStoreItem", b =>
                {
                    ...
                    b.OwnsOne("SCMM.Steam.Data.Store.Types.PersistableGraphDataSet", "TotalSalesGraph", b1 =>
                        {
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamStoreItemItemStore", b =>
                {
                    ...
                    b.OwnsOne("SCMM.Steam.Data.Store.Types.PersistableGraphDataSet", "IndexGraph", b1 =>
                        {
