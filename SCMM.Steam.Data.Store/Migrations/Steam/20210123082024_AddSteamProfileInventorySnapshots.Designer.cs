...
namespace SCMM.Steam.Data.Store.Migrations.Steam
{
    ...
    [Migration("20210123082024_AddSteamProfileInventorySnapshots")]
    partial class AddSteamProfileInventorySnapshots
    {
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.Models.Steam.SteamApp", b =>
                {
                    ...
                    b.OwnsMany("SCMM.Steam.Data.Store.Models.Steam.SteamAssetFilter", "Filters", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
