...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.ImageData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.SteamApp", b =>
                {
                    b.HasOne("SCMM.Steam.Data.Store.ImageData", "Icon")
                        .WithMany()
                        .HasForeignKey("IconId");

                    b.HasOne("SCMM.Steam.Data.Store.ImageData", "IconLarge")
                        .WithMany()
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.SteamAssetWorkshopFile", b =>
                {
                    ...
                    b.HasOne("SCMM.Steam.Data.Store.ImageData", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.SteamProfile", b =>
                {
                    b.HasOne("SCMM.Steam.Data.Store.ImageData", "Avatar")
                        .WithMany()
                        .HasForeignKey("AvatarId");

                    b.HasOne("SCMM.Steam.Data.Store.ImageData", "AvatarLarge")
                        .WithMany()
