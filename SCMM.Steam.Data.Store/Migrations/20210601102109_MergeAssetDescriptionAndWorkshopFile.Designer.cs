...
namespace SCMM.Steam.Data.Store.Migrations
{
    ...
    [Migration("20210601102109_MergeAssetDescriptionAndWorkshopFile")]
    partial class MergeAssetDescriptionAndWorkshopFile
    {
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.SteamAssetDescription", b =>
                {
                    ...
                    b.Property<int?>("CurrentSubscriptions")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset?>("TimeChecked")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("SCMM.Steam.Data.Store.SteamAssetDescription", b =>
                {
                    ...
                    b.OwnsOne("SCMM.Steam.Data.Store.Types.PersistableAssetQuantityDictionary", "BreaksDownInto", b1 =>
                        {
                    ...
                    b.OwnsOne("SCMM.Steam.Data.Store.Types.PersistableAssetQuantityDictionary", "CraftingRequirements", b1 =>
                        {
                            b1.Property<Guid>("SteamAssetDescriptionId")
                                .HasColumnType("uniqueidentifier");
